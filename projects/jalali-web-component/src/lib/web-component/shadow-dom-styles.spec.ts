...
/**
 * Shadow DOM Styles Encapsulation Tests
 * تست‌های Encapsulation برای Shadow DOM Styles
 * 
 ...
 */
describe('Shadow DOM Styles Encapsulation', () => {
  ...
  describe('Style Encapsulation', () => {
    ...
    it('should not affect external elements with component class names', () => {
      // Create an external element with same class name
      ...
      // (external element should not have component-specific styles)
  ...
  describe('CSS Variables', () => {
    ...
    it('should apply CSS variables to component elements', () => {
      ...
      if (container) {
        ...
        // Should have a background color from CSS variables
  ...
  describe('Performance Optimization', () => {
    ...
    it('should have minimal style elements in Shadow DOM', () => {
      const styleElements = element.shadowRoot?.querySelectorAll('style');
      
      // Should have exactly one style element (not multiple)
    ...
    it('should have style element with data attribute for identification', () => {
  ...
  describe('Style Injection Performance', () => {
    ...
    it('should not block rendering', () => {
      ...
      // Should be able to append without blocking
      expect(() => {
        document.body.appendChild(testElement);
        document.body.removeChild(testElement);
      }).not.toThrow();
